 ...
 * @help
 * 
 * ※ 「ウィンドウタッチ仕様変更（トリアコンタン作）」の
 * 枠外キャンセルを動作させるため、
 * 1114～1118行目のTouchInput._onMouseMoveを
 * コメントアウトした。2020/08/31
 * https://tm.lucky-duet.com/viewtopic.php?f=23&t=9883
 * 
 * ピクチャをクリックすると、指定したコモンイベントが
